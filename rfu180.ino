/* RFU180 by Phil Young
My attempt at using the BMP180 with the LLAP protocol
Designed for use on the RFu-328 from Ciseco using low powered sleep mode 2 on the xrf
...
#define DEVICEID "DR"	// this is the LLAP device ID must be 2 characters long
...
//	  // Wait for it to be initialised
	  ...
	  pinMode(9,OUTPUT);
	  digitalWrite(9,HIGH);	// No voltage to the sensor
...
{
	digitalWrite(9,HIGH);
	delay(1000);// provide voltage for the sensor
